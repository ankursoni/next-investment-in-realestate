...
Revision ID: d13d20deec05
Revises: 
Create Date: 2024-06-02 20:10:41.562333
...
def upgrade() -> None:
    ...
    sa.Column('property_type', sa.Enum('HOUSE', 'TOWNHOUSE', name='propertytype'), nullable=False),
    sa.Column('remarks', sa.Unicode(length=200), nullable=False),
    sa.Column('start_time', sa.DateTime(), nullable=True),
    sa.Column('end_time', sa.DateTime(), nullable=True),
    sa.Column('scrape_duration_seconds', sa.Float(), nullable=True),
